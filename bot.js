  ...
  client.on('message', message => {
    if (message.author.bot) return;
     if (message.content === prefix + "help") {
		 message.channel.send('**تم ارسال الهلب فالخاص**');
...
if (message.content.startsWith(adminprefix + 'playing')) {//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
...
return message.reply("** لتغيير الاسم يجب عليك الانتظآر لمدة ساعتين . **");
} else
